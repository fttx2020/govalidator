govalidator
===========
[![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/fttx2020/govalidator?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge) [![GoDoc](https://godoc.org/github.com/fttx2020/govalidator?status.png)](https://godoc.org/github.com/fttx2020/govalidator)
[![Build Status](https://travis-ci.org/fttx2020/govalidator.svg?branch=master)](https://travis-ci.org/fttx2020/govalidator)
[![Coverage](https://codecov.io/gh/fttx2020/govalidator/branch/master/graph/badge.svg)](https://codecov.io/gh/fttx2020/govalidator) [![Go Report Card](https://goreportcard.com/badge/github.com/fttx2020/govalidator)](https://goreportcard.com/report/github.com/fttx2020/govalidator) [![GoSearch](http://go-search.org/badge?id=github.com%2Fasaskevich%2Fgovalidator)](http://go-search.org/view?id=github.com%2Fasaskevich%2Fgovalidator) [![Backers on Open Collective](https://opencollective.com/govalidator/backers/badge.svg)](#backers) [![Sponsors on Open Collective](https://opencollective.com/govalidator/sponsors/badge.svg)](#sponsors) [![FOSSA Status](https://app.fossa.io/api/projects/git%2Bgithub.com%2Fasaskevich%2Fgovalidator.svg?type=shield)](https://app.fossa.io/projects/git%2Bgithub.com%2Fasaskevich%2Fgovalidator?ref=badge_shield)
...
Type the following command in your terminal:
	...
	go get github.com/fttx2020/govalidator

or you can get specified release of the package with `gopkg.in`:

	go get gopkg.in/fttx2020/govalidator.v10
...
```go
import "github.com/fttx2020/govalidator"
```
If you are unhappy to use long `govalidator`, you can do something like this:
```go
import (
  valid "github.com/fttx2020/govalidator"
)
```
...
#### Recent breaking changes (see [#123](https://github.com/fttx2020/govalidator/pull/123))
...
```
###### ValidateStruct [#2](https://github.com/fttx2020/govalidator/pull/2)
...
println(result)
```
###### ValidateMap [#2](https://github.com/fttx2020/govalidator/pull/338)
...
#### Notes
Documentation is available here: [godoc.org](https://godoc.org/github.com/fttx2020/govalidator).
Full information about code coverage is also available here: [govalidator on gocover.io](http://gocover.io/github.com/fttx2020/govalidator).
...
#### Special thanks to [contributors](https://github.com/fttx2020/govalidator/graphs/contributors)
